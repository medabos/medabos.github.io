...
function getAdjustingStep(adjustingset, step) {
    ...
    obj = JSON.parse(text);
    var subopj = obj[adjustingset];

    document.getElementById("step").value = step;
    document.getElementById("a-name").innerHTML = subopj["step" + step].name;
    document.getElementById("a-instructions").innerHTML = subopj["step" + step].instructions;
    document.getElementById("a-direction").innerHTML = subopj["step" + step].direction;
    document.getElementById("a-controller").innerHTML = subopj["step" + step].controller;
    document.getElementById("a-img").innerHTML = subopj["step" + step].imgpath;
    document.getElementById("a-troubleshooting").innerHTML = subopj["step" + step].troubleshooting;
    document.getElementById("a-turnin").innerHTML = subopj["step" + step].turnin;
    document.getElementById("a-turnout").innerHTML = subopj["step" + step].turnout;
    document.getElementById("a-info1").innerHTML = subopj["step" + step].info1;
    document.getElementById("a-info2").innerHTML = subopj["step" + step].info2;
}
