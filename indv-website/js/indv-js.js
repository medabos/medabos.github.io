...
function getAdjustingStep(step) {
    //Retrieve data:
    text = localStorage.getItem("adjustingGuideData");
    obj = JSON.parse(text);
    document.getElementById("step").value = step;
    document.getElementById("a-name").innerHTML = obj["step" + step].name;
    document.getElementById("a-instructions").innerHTML = obj["step" + step].instructions;
    document.getElementById("a-direction").innerHTML = obj["step" + step].direction;
    document.getElementById("a-controller").innerHTML = obj["step" + step].controller;
    document.getElementById("a-img").innerHTML = obj["step" + step].imgpath;
    document.getElementById("a-troubleshooting").innerHTML = obj["step" + step].troubleshooting;
    document.getElementById("a-turnin").innerHTML = obj["step" + step].turnin;
    document.getElementById("a-turnout").innerHTML = obj["step" + step].turnout;
    document.getElementById("a-info1").innerHTML = obj["step" + step].info1;
    document.getElementById("a-info2").innerHTML = obj["step" + step].info2;
}
...
function nextStep() {
    ...
    currentStepNumber += 1;
    if (currentStepNumber < 22) {
        getAdjustingStep(currentStepNumber);
    }
}
